          ...
          >
            ...
            <div className="flex flex-col items-start gap-3">
              <div className="flex items-center gap-1">
                <span
                  className="flex items-center justify-center font-['Pretendard'] font-semibold text-[14px] rounded-full"
                  style={{
                    backgroundColor: "#FB4D40",
                    color: "#FEE4E2",
                    padding: "4px 12px",
                  }}
                >
              ...
              <p className="font-['Pretendard'] text-[24px] font-semibold leading-tight flex items-baseline text-white">
                {p.id}
            ...
            {/* 오른쪽 섹션: 환자중증도 / 주요증상 / 초기활력징후 */}
            <div className="flex items-center gap-4">
              {/* 환자 중증도 */}
              <div className="flex flex-col items-start">
                <p className="font-['Pretendard'] text-[#A3A3A3] text-[12px] font-normal mb-1">
                  환자 중증도
                </p>
                <div className="bg-[#404040] rounded-2xl px-5 py-4">
                  <span className="bg-[#FDEAEA] text-[#D0312D] font-['Pretendard'] text-[14px] font-medium px-3 py-1 rounded-full inline-block">
                    {p.condition}
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="bg-[#404040] rounded-2xl px-5 py-4 flex gap-1.5">
                  {p.symptoms.map((sym, idx) => (
                    <span
                      key={idx}
                      className="bg-[#E6EEFF] text-[#2D63EA] font-['Pretendard'] text-[14px] font-medium px-3 py-1 rounded-full inline-block"
                    >
                      {sym}
                    </span>
                  ))}
                ...
                <div className="bg-[#404040] rounded-2xl px-5 py-[11px] flex items-center gap-6">
                  {p.vitals.map((v, idx) => (
                    <div key={idx} className="flex flex-col items-center relative">
                      <p className="font-['Pretendard'] text-[12px] font-normal text-[#A3A3A3]">
                        {v.label}
                      </p>
